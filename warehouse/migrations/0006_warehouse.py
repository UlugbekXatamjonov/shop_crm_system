...
#
# Eslatma: SeparateDatabaseAndState dan standart Django operatsiyalariga
# o'tkazildi — SQLite va PostgreSQL da ham ishlaydi.
# Production da bu migration allaqachon applied bo'lgani uchun qayta ishlamaydi.
